          ...
          <footer className="w-full bg-background border-t border-white/5 py-12 z-20 relative">
               <div className="mx-auto flex max-w-6xl flex-col items-center justify-center gap-4 px-4 text-center md:flex-row md:justify-between">
                    <p className="flex items-center justify-center gap-2 text-sm text-foreground/50 flex-wrap">
                         © 2026 <img src="/image.png" alt=" Logo" className="h-5 w-5 object-cover rounded-md mx-1" /> KOMEQ<span className="text-red-500 font-bold pl-1 pr-1">[R]</span>Self Balancing Product. All rights reserved.
                    </p>
