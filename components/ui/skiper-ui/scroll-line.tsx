...
export const ScrollLine = ({ className }: { className?: string }) => {
     ...
     // Map scroll progress to path drawing completion
     const pathLength = useTransform(scrollYProgress, [0, 1], [0.0, 1]);

     return (
          <div className={cn("pointer-events-none absolute inset-x-0 top-0 h-[400vh] z-0 flex justify-center overflow-hidden opacity-30 text-foreground dark:opacity-40", className)}>
               <svg
                    width="1278"
                    height="3500" // Stretched vertically to cover more page height
                    viewBox="0 0 1278 2669"
                    fill="none"
                    overflow="visible"
                    xmlns="http://www.w3.org/2000/svg"
                    className="w-full max-w-5xl h-full preserve-3d"
