          ...
          <div className="relative flex min-h-[60vh] w-full flex-col justify-center bg-background text-foreground z-10 overflow-hidden">
               ...
               <div className="relative z-20 mx-auto flex w-full max-w-6xl flex-col items-center justify-between gap-16 px-6 py-24 md:flex-row">
                    ...
                    <div className="flex w-full max-w-sm flex-col items-center gap-8 md:flex-1">
                         ...
                         <div className="mt-12 w-full rounded-2xl border border-white/10 bg-black/20 backdrop-blur-sm p-1">
                              {/* Using standard div with overflow instead of ScrollArea primitive so we avoid missing dependencies */}
                              <div className="h-72 w-full overflow-y-auto overflow-x-hidden rounded-xl no-scrollbar">
                                   <div className="space-y-1 p-1">
                                        {[
                                             "Core Logic Engine", "Hardware Architect", "Embedded Systems",
                                             "PID Control Systems", "3D Printing & Design", "Sensor Calibration",
                                             "Battery Management", "Motor Drivers", "Quality Assurance",
                                             "UI/UX Design", "Project Visionary"
                                        ].map((role, index) => (
                                             <div
                                                  key={index}
                                                  className="flex h-12 w-full items-center gap-3 rounded-lg px-4 text-foreground/50 transition-colors hover:bg-foreground/10 hover:text-foreground"
                                             >
